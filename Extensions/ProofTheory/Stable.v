...
Class PropositionalStable (L: Language) {minL: MinimumLanguage L} {pL: PropositionalLanguage L} (Gamma: Provable L) (stable: expr -> Prop) := {
...
Class ModalStable (L: Language) {minL: MinimumLanguage L} {mL: ModalLanguage L} (Gamma: Provable L) (stable: expr -> Prop) := {
  boxp_stable: forall x, stable x -> stable (boxp x)
}.

Class ModalAbsorbStable (L: Language) {minL: MinimumLanguage L} {mL: ModalLanguage L} (Gamma: Provable L) (stable: expr -> Prop) := {
...
Lemma iffp_stable {L: Language} {minL: MinimumLanguage L} {pL: PropositionalLanguage L} {Gamma: Provable L} {stable: expr -> Prop} {pstable: PropositionalStable L Gamma stable}:
...
Lemma truep_stable {L: Language} {minL: MinimumLanguage L} {pL: PropositionalLanguage L} {Gamma: Provable L} {stable: expr -> Prop} {pstable: PropositionalStable L Gamma stable}:
  stable TT.
Proof.
