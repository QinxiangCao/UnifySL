...
Instance MonoPred_fmSM (A: Type) {R1: KI.Relation A} {po_R1: PreOrder KI.Krelation} {R2: KM.Relation A} {uR2: UpwardsClosedOrderedKripkeModel A} : @FlatModalSemantics (MonoPred_L A) (MonoPred_nL A) (MonoPred_mL A) (Build_Model A) (unit_kMD _) tt R1 R2 (MonoPred_SM A).
Proof.
  constructor.
